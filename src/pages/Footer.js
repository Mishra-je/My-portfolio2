...
export const Footer = () => {
  const containerStyle = {
    ...
    color: 'rgba(255, 255, 255, 0.1)' // 50% containerStyle white text
  };
  return (
    <div>
      <div className="mt-8 lg:block hidden bg-[#02474d] pt-9">
        <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            <div className="md:w-[316px]">
              <p className="text-[18px] font-medium text-white">
                <h1 className="text-white font-extrabold">
                  <span className="text-rose-600">Sachin YOUR</span>LOGO
                </h1>
              </p>
              ...
              <div className="mt-[18px] flex gap-4">
                <a className="hover:scale-110" target="_blank" href="facebook.com">
                {<FaFacebook/>}
                </a>
                <a className="hover:scale-110" target="_blank" href="linkdin.com">
                 {<FaLinkedin/>}
                </a>
                <a className="hover:scale-110" target="_blank" href="instagram.com">
                 {<FaInstagram/>}
                </a>
                <a className="hover:scale-110" target="_blank" href="youtube.com">
                 {<FaYoutube />}
                </a>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
            <p className="text-[10px] font-normal text-white md:text-[12px]">
              © Copyright -- --2024 -- --, All Rights Reserved by YOUR WEBSITES.
              PVT. LTD
            </p>
          </div>
        </div>
      </div>
      <footer className="bg-gray-800 text-white py-4 px-3 mt-16 lg:hidden ">
    <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="w-full md:w-1/2 md:text-center md:mb-0 mb-8">
            <ul className="list-reset flex justify-center flex-wrap text-xs md:text-sm gap-3">
                <li><a href="google.com" className="text-gray-400 hover:text-white">Contact</a></li>
                <li className="mx-4"><a href="google.com" className="text-gray-400 hover:text-white">Privacy Policy</a></li>
                <li><a href="google.com" className="text-gray-400 hover:text-white">Terms of Use</a></li>
            </ul>
        </div>
    </div>
      </footer>
